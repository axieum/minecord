...
public final class StringUtils
{
    ...
    public static final HashMap<ResourceLocation, String> WORLD_NAMES = new HashMap<>(3);
     ...
     * @see #deriveLevelName(ResourceLocation)
     */
    public static String getLevelName(final ResourceKey<Level> level)
    {
        final ResourceLocation identifier = level.registry();
        return I18nConfig.worlds.getOrDefault(identifier.toString(), deriveLevelName(identifier));
    }
     ...
     */
    public static String deriveLevelName(final ResourceLocation identifier)
    {
        return WORLD_NAMES.computeIfAbsent(identifier, id -> {
            // Space delimited identifier with leading 'the' keywords removed
