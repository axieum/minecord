...
## [2.1.2+1.21.11](https://github.com/axieum/minecord/compare/v2.1.2+1.21.9...v2.1.2+1.21.11) (2026-01-26)


### Build System

* add support for Minecraft 1.21.11+ ([8798072](https://github.com/axieum/minecord/commit/879807223094386ef9c641a835385beac8d024c9))
* **api:** add support for Minecraft 1.21.11+ ([7d9c77b](https://github.com/axieum/minecord/commit/7d9c77b7c09e66bdec883018c24382df227eed0d))
* **chat:** add support for Minecraft 1.21.11+ ([2d66088](https://github.com/axieum/minecord/commit/2d66088d8e681cea082a316048bdd31eaf06ac9d))
* **cmds:** add support for Minecraft 1.21.11+ ([7c1cf4d](https://github.com/axieum/minecord/commit/7c1cf4de724fee0d4a2a4da35b403158be01d24e))
* **presence:** add support for Minecraft 1.21.11+ ([39b052e](https://github.com/axieum/minecord/commit/39b052e3aa557d18e30c24004c87ee548a5cff16))

## [2.1.2+1.21.9](https://github.com/axieum/minecord/compare/v2.1.2+1.21.7...v2.1.2+1.21.9) (2025-10-11)


### Build System

* add support for Minecraft 1.21.9+ ([de2d883](https://github.com/axieum/minecord/commit/de2d883423f2341e4d03fc2bebe8bde4d11ba365))
* **api:** add support for Minecraft 1.21.9+ ([4b47992](https://github.com/axieum/minecord/commit/4b47992b0aaa7bd04b650821cd941ef747976504))
* **chat:** add support for Minecraft 1.21.9+ ([9e77f5b](https://github.com/axieum/minecord/commit/9e77f5ba48fee7f0bb04984e7e38a1309b4ba1b0))
* **cmds:** add support for Minecraft 1.21.9+ ([5bcf922](https://github.com/axieum/minecord/commit/5bcf9221a5442633b83ebc719d6f21d064a1d98d))
* **presence:** add support for Minecraft 1.21.9+ ([2645faf](https://github.com/axieum/minecord/commit/2645faf0d775e7cdc78d14ce1224c4a39dcb0464))

## [2.1.2+1.21.7](https://github.com/axieum/minecord/compare/v2.1.2+1.21.6...v2.1.2+1.21.7) (2025-07-01)


### Build System

* add support for Minecraft 1.21.7+ ([b869e50](https://github.com/axieum/minecord/commit/b869e50870a1ed5bad68d80a57da30bed3016c07))
...
* **chat:** add support for Minecraft 1.21.7+ ([be5ed57](https://github.com/axieum/minecord/commit/be5ed577001d0e026536e46405483739a199282c))
* **cmds:** add support for Minecraft 1.21.7+ ([75b110f](https://github.com/axieum/minecord/commit/75b110fc68f0c33cdb44c72c27ab77fffdc5f0dc))
* **presence:** add support for Minecraft 1.21.7+ ([5624a6c](https://github.com/axieum/minecord/commit/5624a6c429f4093ead370f988df5665eae30a86d))
...
* add support for Minecraft 1.21.6+ ([4adb1b6](https://github.com/axieum/minecord/commit/4adb1b676afa9396723a93762575093b3767bf1b))
...
* **chat:** add support for Minecraft 1.21.6+ ([7a82dcc](https://github.com/axieum/minecord/commit/7a82dcc754c095412a15c7654400840fa93092ef))
* **cmds:** add support for Minecraft 1.21.6+ ([6271d7c](https://github.com/axieum/minecord/commit/6271d7c8672855052706e9bbbe4e53b99f23c6af))
...
* add support for Minecraft 1.21.3+ ([#157](https://github.com/axieum/minecord/issues/157)) ([767e478](https://github.com/axieum/minecord/commit/767e478d804e45a7e60525822152ba7d1ac9e292))
...
* **cmds:** add support for Minecraft 1.21.3+ ([#161](https://github.com/axieum/minecord/issues/161)) ([f7acdd6](https://github.com/axieum/minecord/commit/f7acdd6cbf2ea319baff5aca417aa5e5d58f8095))
